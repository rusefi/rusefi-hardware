...
"Connector to wires" breakout and adapter boards. Vehicle-specific adapter boards let you keep the original harness intact and plug a rusEFI ECU (usually via superseal) into the stock connector.
...
* [146 pin](BMW-N52-146) BMW N52 ([pinout](https://rusefi.com/docs/pinouts/BMW-N52-146/))
* [146 pin](BMW-N54-146) BMW N54 ([pinout](https://rusefi.com/docs/pinouts/BMW-N54-146/))
...
More breakout boards (35 to 134 pin: Mazda, Chrysler NGC, Mitsubishi, Motronic, Ford EEC-IV, VAG, BMW) live in the main repo at https://github.com/rusefi/rusefi/tree/master/hardware
